...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<jsp:include
			page="${pageContext.request.contextPath}/jsp/inc/header.jsp" />
		<jsp:include
			page="${pageContext.request.contextPath}/jsp/inc/leftSideBar.jsp" />
	...
	<!-- date-range-picker -->
	<script
		src="${pageContext.request.contextPath}/bootstrap/js/moment.min.js"></script>
	<script
